    ...
    <div className="m-1">
       ...
       <div className="m-2 text-center imgIntroMe"><img src={imgme}/></div>
        <div className="col-4 text-center mx-auto">
            <p>
            Hello! <h3 className="m-200" style={{color: "white"}}>This is ...👋</h3>I am a student from University and Im so interested in the world of coding specifically for web development.
            </p>
        </div>
    </div>
